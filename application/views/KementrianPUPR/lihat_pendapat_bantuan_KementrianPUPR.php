...
<html lang="en">
  ...
  <style>
    ...
    <title>Halaman Kementrian PUPR</title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url(); ?>index.php/user/KementrianPUPR" class="site_title"><img src="<?php echo base_url('assets/gambar/smd.gif');?>" width="50px"></i> <img src="<?php echo base_url('assets/gambar/dinsos.png');?>" width="155px"></a>
            </div>
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 ">
            ...
            <div class="x_panel">
              <div class="x_title">
                <h2>Pemilihan Masyarakat Pendapat Bantuan Periode 2019 <?php //echo date('Y'); ?></h2>
                  ...
                  <div class="x_content">
                    <div class="row-sm-12">
                        ...
                        <div class="col-sm-12">
                            ...
                            <table id="data-nilai" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                    <th>No</th>
                                    <th>No KTP</th>
            ...
            <div class="x_panel">
              <div class="x_title">
                <h2>Rekomendasi Pemilihan Bantuan Rumah Tidak Layak Huni Periode 2019 <?php //echo date('Y'); ?></h2>
                <ul class="nav navbar-right panel_toolbox">
                  <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>  
                </ul>
                  <div class="clearfix">
                            ...
                            <div id="notifications"><?php echo $this->session->flashdata('rek'); ?></div>
                                ...
                                <tr>
                                  <td><?php echo $no;?></td><?php $no++;?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                          <form method="POST" action="<?php echo base_url(); ?>index.php/pemilihan/pilihRekomendasiPendapatBantuanPUPR">
                                            <input type="hidden" name="idPemilihan" value="<?php echo $r->idPemilihan; ?>">
                                            <input type="image" src="<?php echo base_url('assets/gambar/approve.png');?>" style="width:20px"; onclick="return confirm('Anda Yakin memilih penerima bantuan ?')">
                                          </form>
                                        </div>
                                    </div>
                                    </td>
