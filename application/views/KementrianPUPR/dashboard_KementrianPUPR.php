      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
              <div class="x_title">
              <h2>Dashboard Kementrian PUPR</h2>
              ...
              <!-- Isi Konten Disini -->
                ...
                <div class="col-sm-3 col-sm-3">
                  <div class="card"><center>
                    ...
                    <a href="<?php echo base_url(); ?>index.php/pemilihan/KelolaPendapatBantuanKementrianPUPR">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>          
                <!-- Akhir Card -->
                ...
                <div class="col-sm-3 col-sm-3">
                  <div class="card"><center>
                    ...
                    <h4><b><br>Pendapat Bantuan Kementrian PUPR</b></h4>
                    <h3><b><?php echo $jumlahPenerimaBantuanKementrianPUPR ?></b></h3>
                    </div>
                    <div class="card-footer ">
                    <a href="<?php echo base_url(); ?>index.php/pemilihan/KelolaPendapatBantuanKementrianPUPR">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
            ...
            <div class="x_title">
              <h2>Grafik Sistem Rekomendasi Rumah Tidak Layak Huni Kabupaten Sumedang</h2>
                <ul class="nav navbar-right panel_toolbox">
                  ...
                  <div class="col-md-6">
                        <h4><center>Statistik Penerima Bantuan Periode 2019 <?php //echo date('Y'); ?></center></h4><br>
                          <div style="width:100%;height: 20%">
		                      <canvas id="penerimaBantuan"></canvas>
    	                  </div>
                      </div>
                  </div>
                  </div>
                  ...
                  ?>
                    <script>
                    var ctx = document.getElementById("penerimaBantuan").getContext('2d');
