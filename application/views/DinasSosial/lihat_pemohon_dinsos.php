...
<html lang="en">
  ...
  <body class="nav-md">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          <div class="card-box table-responsive">
                            <table id="data-persetujuan" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <div id="notifications"><?php echo $this->session->flashdata('edt'); ?></div>
                                ...
                                <?php foreach($pemohon as $pmh){ ?>
                                    ...
                                    <div class="row">
                                      <div class="col-sm-2">
                                        <form method="POST" action="<?php echo base_url(); ?>index.php/pemohon/setujuPemohon">
                                          <input type="hidden" name="noKTP" value="<?php echo $pmh->noKTP; ?>">
                                          <input type="image" src="<?php echo base_url('assets/gambar/approve.png');?>" style="width:20px"; onclick="return confirm('Yakin Menyetujui Pemohon ?')">
                                        </form>
                                      </div>
                                      <div class="col">
                                        <form method="POST" action="<?php echo base_url(); ?>index.php/pemohon/printProposalDinsos" target="blank">
                                          <input type="hidden" name="noKTP" value="<?php echo $pmh->noKTP; ?>">
                ...
                <ul class="nav navbar-right panel_toolbox">
                  ...
                  <div class="x_content">
                    <div class="row">
                        <div class="col-sm-12">
                          <div class="card-box table-responsive">
                            <table id="data-setuju" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                    <th>No KTP</th>
                                    <th>Nama Pemohon</th>
                                ...
                                <tbody>
                                <?php foreach($pemohonSetuju as $pmhstj){ ?>
                                    <tr>
                                    <td><?php echo $pmhstj->noKTP; ?></td>
                                    <td><?php echo $pmhstj->namaPemohon; ?></td>
                                    <td><?php echo $pmhstj->jenisKelamin; ?></td>
                                    <td><?php echo $pmhstj->alamat; ?></td>
                                    <td><?php echo $pmhstj->statusPersetujuan; ?></td>
                                    <td><?php echo $pmhstj->proposal; ?></td>
                                    <td>
                                    <div class="row">
                                      <div class="col">
                                        <form method="POST" action="<?php echo base_url(); ?>index.php/pemohon/printProposalDinsos" target="blank">
                                          <input type="hidden" name="noKTP" value="<?php echo $pmhstj->noKTP; ?>">
                                          <input type="image" src="<?php echo base_url('assets/gambar/pdf.png');?>" style="width:18px";>
                                        </form>
                                      </div>
                                    </div>
    ...
    $(document).ready(function(){
      $('#data-persetujuan').DataTable();
    });
    </script>
    <script>
    $(document).ready(function(){
      $('#data-setuju').DataTable();
    });
    </script>
  </body>
</html>