          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <form action="<?php echo base_url(); ?>index.php/pemohon/tambahUser" method="post">
                    <div class="field item form-group">
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Email<span
                          class="required">*</span></label>
                      <div class="col-md-6 col-sm-6">
                        <input class="form-control" name="email" placeholder="Masukkan Email" type="email" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ@.1234567890',this)" required /></div>
                    </div>
                    <div class="field item form-group">
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Password<span
                          class="required">*</span></label>
                      <div class="col-md-6 col-sm-6">
                        <input class="form-control" name="password" placeholder="Masukkan Password" type="text" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890 ',this)" required /></div>
                    </div>
                    <div class="field item form-group">
                      ...
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Level<span
                        ...
                        <div class="col-md-6 col-sm-6">
                            <select name="level" class="form-control" required>
                                ...
                                <option value="KementrianPUPR">Kementrian PUPR</option>
                            </select>
                        </div>
                    </div>
                    <div class="ln_solid">
                      <div class="form-group">
                        <div class="col-md-6 offset-md-3">
                          <button type='submit' class="btn btn-primary" onclick="return confirm('Yakin Tambah User ?')">Submit</button>
