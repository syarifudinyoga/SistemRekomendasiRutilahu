            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form action="<?php echo base_url(); ?>index.php/pemohon/ubahUser" method="post">
                    <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Email<span
                            class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                          <input class="form-control" name="email" type="hidden" value="<?php echo $user[0]->email;?>"/>
                          <input class="form-control" name="email" type="text" value="<?php echo $user[0]->email;?>" disabled />
                        </div>
                      </div>
                      <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Password<span
                            class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                          <input class="form-control" name="password" type="hidden" value="<?php echo $user[0]->password;?>"/>
                          <input class="form-control" name="password" type="text" value="<?php echo $user[0]->password;?>" disabled/>
                      </div>
                      </div>
                      <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Nama<span
                            class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                          <input class="form-control" name="nama" placeholder="Masukkan Nama Ketua Kelompok" type="hidden" value="<?php echo $user[0]->nama;?>"/>
                          <input class="form-control" name="nama" placeholder="Masukkan Nama Ketua Kelompok" type="text" value="<?php echo $user[0]->nama;?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ',this)" required />
                        </div>
                      </div>
                      <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Level<span
                            class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                          <input class="form-control" name="level" type="hidden" value="<?php echo $user[0]->level;?>"/>
                          <input class="form-control" name="level" type="text" value="<?php echo $user[0]->level;?>" disabled/>
                      </div>
                      </div>        
                      <div class="ln_solid">
                        <div class="form-group">
                          <div class="col-md-6 offset-md-3">
                      <button type='submit' class="btn btn-primary" onclick="return confirm('Yakin Ubah User ?')">Submit</button>
