                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="field item form-group">
                        ...
                        <label class="col-form-label col-md-3 col-sm-3  label-align"><?php echo $user[0]->email;?></label>
                        </div>
                      </div>
                      <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Password<span
                            class="required"> :</span></label>
                            <div class="col-md-1 col-sm-6">
                            <label class="col-form-label col-md-3 col-sm-3  label-align"><?php echo $user[0]->password; ?></label>
                      </div>
                      </div>
                      <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Nama Kelompok <span
                            class="required"> :</span></label>
                            <div class="col-md-1 col-sm-6">
                            <label class="col-form-label col-md-3 col-sm-3  label-align"><?php echo $user[0]->nama;?></label>
                        </div>
                      </div>
                      <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Level<span
                            class="required"> :</span></label>
                            <div class="col-md-1 col-sm-6">
                            <label class="col-form-label col-md-6 col-sm-6  label-align"><?php echo $user[0]->level;?></label>
                      </div>
                      </div>
                  </div>
                </div>
